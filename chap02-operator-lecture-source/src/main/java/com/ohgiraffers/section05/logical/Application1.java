...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 논리 연산자의 종류
        * 1. 논리 연결 연산자
        * 두 개의 피연산자를 가지는 이항 연산자이며, 연산자의 결합 방향은 왼쪾에서 오른쪽이다
        ...
        * */
        ...
        System.out.println("false와 true의 논리 or 연산 : " + (false || true)); // false
        System.out.println("false와 false의 논리 or 연산 : " + (false || false));

        System.out.println();
        System.out.println("=============== 논리 not 연산 ==============");
        System.out.println("true의 논리 not 연산 : " + (!true)); // true
