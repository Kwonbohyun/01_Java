...
public class Application {
    public static void main(String[] args) {
        ...
        * 연산자 중 참 혹은 거짓을 반환하는 연산잔즌 삼항연산자의 조건식이나 조건문의 조건절에 많이 사용한다
        * */
        ...
        * '>=' : 왼쪽의 피연산자가 오른쪽의 피연자보다 같거나 크면 true 아니면 false를 반환
        ...
        * */
        ...
        System.out.println("ch1이 ch2보다 큰지 비교 : " + (ch1 > ch2)); //false
        System.out.println("ch1이 ch2보다 크거나 같은지 비교 : " + (ch1 >= ch2)); //false
        System.out.println("ch1이 ch2보다 작은지 비교 : " + (ch1 < ch2)); //true
        System.out.println("ch1이 ch2보다 작거나 같은지 비교 : " + (ch1 <= ch2)); //true
        ...
        System.out.println("bool1이 bool2보다 큰지 비교 : " + (bool1 != bool2)); //false
        System.out.println("bool1이 bool2보다 크거나 같은지 비교 : " + (bool1 != bool2)); //false
        System.out.println("bool1이 bool2보다 작은지 비교 : " + (bool1 != bool2)); //true
        System.out.println("bool1이 bool2보다 작거나 같은지 비교 : " + (bool1 != bool2)); //true
        ...
        //             System.out.println("str1이 str2보다 큰지 비교 : " + (str1 > str2)); //false
        //             System.out.println("str1이 str2보다 크거나 같은지 비교 : " + (str1 >= str2)); //false
        //             System.out.println("str1이 str2보다 작은지 비교 : " + (str1 < str2)); //true
        //             System.out.println("str1이 str2보다 작거나 같은지 비교 : " + (str1 <= str2)); //true
