...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * stack에서 값을 꺼내는 메소드
        * peak() : 해당 스택의 가장 마지막에 이쓴ㄴ 요소 반환
        * pop() : 해당 스탵ㄱ의 가장 마지막에 있는 요소 반환, 반환 후 제거
        * */


        System.out.println("peak(0 : " + integerStack.peek());
        System.out.println("pop() : " + integerStack.pop());
        System.out.println("pop() 이후 integerStack.pop" + integerStack);
