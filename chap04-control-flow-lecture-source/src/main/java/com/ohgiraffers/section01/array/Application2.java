...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * 발생한 주소를 래퍼런스 변수(참조형 변수)에 저장하고 이것을 참조하여 사용하기 때문에
        * 참조 자료형 이라고 한다.
        * */


        // 배열의 할당을 할 시에는 반드시 배열의 크기를 지정해 줘야한다.
        ...
        /*
        * hashcode() : 일반적으로 객체의 주소값을 10-진수로 변환하여 생성한 객체의 고유한 정수값을 반환
        * -> 동일객체인지 비교할 떄 사용할 목적으로 많이쓰이며, 동등객체로 취급하기 위한 용도로 overring 해서 사용한다.
        * */


         System.out.println("iarr2의 hashcode : " + iarr2.hashCode());
         System.out.println("char2의 hashcode : " + iarr2.hashCode());

         // 배열의 길이를 알 수 있는 기능을 필드로 제공하고 있다.
        System.out.println("iarr2의 길이 : " + iarr2.length);
        System.out.println("carr2의 길이 : " + iarr2.length);
        ...
        // 배열의 사이즈를 변경한 것이 아니고, 새로운 배열을 생성해서 그 주소값을 래퍼런스 변수에 덮어 쓴 것이다.
