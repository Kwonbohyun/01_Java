...
public class Application {
     ...
     * 이러한 객체를 설계할 떄는 행위가 아닌 데이턴가 위주이며, 캡슐화의 원칙을 준수하여
    ...
    System.out.println("회원명 : "+member.getNumber());
    System.out.println("회원나이 : "+member.getNumber());
    System.out.println("회원성별 : "+member.getNumber());
    System.out.println("회원 키 : "+member.getNumber());
    System.out.println("회원 몸무게 : "+member.getNumber());
    System.out.println("회원 활성화 상태 : "+member.getNumber());
}
