...
public class Application {
    ...
    * */
        ...
        * 자식클래스가 정의한 매소드대로 동작하도록 구현 몸체 부분을 새롭게 다시 작성하는 기술
        * 메소드 재정의를 하면 메소드를 호출할 시 재정한 매소드가 우선적으로 동작하게된다.
        * */
        ...
        * 적절 해야한다. 적절한 책임을 가진 객체들이 서로 협력(메세지 수신과 응답)을 통해 프로그램을
        * 동작하는것 => 객체지향 프로그램
        * */
        ...
        RacingCar raciingCar = new RacingCar();

        raciingCar.soundHorn();
        raciingCar.run();
        raciingCar.soundHorn();
        raciingCar.stop();
        raciingCar.soundHorn();
