...
public class Application3 {
    public static void main(String[] args) {
        ...
        * 변수의 명명 규칙
        *
        * 변수의 이름을 지울 때 아무렇게나 짓는 것이 아닌 정해진 규칙이 존재한다.
        * 실무적으로 굉장히 중요하기 때문에 숫자가 필수적이다.
        ...
        *   1-2. 예약어는 사용이 불가능하다.
        *     예약어? : 자바에서 미리 사용하겠다고, 컴파일러의 약속한 키워드들을 의미한다.
        *   1-3. 변수명은 대문자와 소문자를 구분합니다.
        *   1-4. 변수명은 숫자로 시작할 수 없다. (시작만 할 수 없고, 숫자를 섞는건 가능하다.)
        *   1-5. 특수 기호는 '_'와 '$'만 사용가능하다. (공백을 사용할 수 없습니다.)
        ...
        *       상수를 사용할 때 특수하게 사용한다.
        *   2-4. 한글로 변수명을 짓는게 가능 하지만, 권장되진 않는다. (한글을 취급하는 다양한 방식 때문에 에러 유발)
        ...
        * */
        ...
        // 압묵적 약속
        int sjdlkjaskdjklasjfkljakfqww; // 이렇게는 사용하지 말자.

        /*
        * 카멜케이스
        *
        * 합성어 일경우 첫단어는 모두 소문자, 두번째 시작 단어는 대문자로 시작한다.
        * 자바에서는 클래스명망 유일하게 대문자로 시작한다.
        * */
        int maxAge = 20;
        int minAge = 10;
